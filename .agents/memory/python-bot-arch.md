...
- Cooldowns: short spam cooldowns (5–10s) use in-memory dict; daily/weekly use DB timestamps (last_daily, last_weekly, last_work cols on users table)
- All in-memory cooldowns reset on restart — see follow-up task #4 to fix
